...
st.set_page_config(page_title="BKK Park & Air Quality Dashboard", layout="wide")

st.title("🏙️ BKK Park & Air Quality Project")
st.write("ยินดีต้อนรับเข้าสู่แดชบอร์ดวิเคราะห์ข้อมูลสวนสาธารณะใน กทม. และค่าฝุ่น PM2.5")
