...
# ----------------------------------------------------------------------
# 🌟 [เพิ่มใหม่] CUSTOM CSS FOR GLASSMORPHIC PARK BACKGROUND
# ----------------------------------------------------------------------
st.markdown("""
<style>
    /* 1. ใส่รูปพื้นหลังสวนสาธารณะที่ชั้นล่างสุด */
    .stApp {
        background-image: url("https://images.unsplash.com/photo-1519331379826-f10be5486c6f?q=80&w=1920");
    ...
    /* 2. สร้างชั้นสีขาวโปร่งแสงครอบ Main Content ทั้งหมดเพื่อให้ข้อมูลชัดเจน */
    ...
    /* 3. ปรับสไตล์กล่อง KPI ให้เข้ากับธีมขาวใส */
    .kpi-card { 
    ...
    /* 4. ปรับพื้นหลังตารางให้โปร่งแสงเข้ากัน */
    .stDataFrame {
...
def load_data():
    ...
    park_data = {
        ...
        "District": [
            ...
            "บางขุนเทียน", "บางขุนเทียน", "滿足ขุนเทียน", "บางขุนเทียน", "บางขุนเทียน", "บางขุนเทียน",
...
with pair2_col2:
    ...
    if not df_park_filtered.empty:
        ...
        # กราฟโดนัทโทนสี Blue Gradient แมตช์กับรูปพื้นหลังสวน
        fig_donut = px.pie(
